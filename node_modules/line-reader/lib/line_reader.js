(function() {
  ...
  function LineReader(fd, cb, separator, encoding, bufferSize, position, bufferStr) {
    var filePosition   = position || 0,
    ...
    this.getBufferStr = getBufferStr;
    this.setBufferStr = setBufferStr;
    this.getFilePosition = getFilePosition;
  ...
  function open(filename, cb, position, separator, encoding, bufferSize, bufferStr) {
    fs.open(filename, 'r', parseInt('666', 8), function(err, fd) {
      ...
      reader = new LineReader(fd, function() {
        cb(reader);
      }, separator, encoding, bufferSize, position, bufferStr);
    });
  }
